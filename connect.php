...
die('Connection Failed : '.$conn->connect_error);
  ...
  $stmt = "INSERT INTO studentdetails (uniqueid, name, email, phone_number, university_name, degree, semester, cgpa, address, resume_link, linkedin_profile, github_link, marksheet10, marksheet12, certificate_link)
  VALUES ('$uniqueid', '$name', '$email', '$number', '$uname', '$degree', '$semester', '$cgpa', '$address', '$resume', '$linkedin', '$github', '$marksheet10', '$marksheet12', '$certificate')";
